    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gametype', models.CharField(choices=[('2v2 best ball', '2v2 best ball'), ('2v2 best ball - matchplay', '2v2 best ball - matchplay'), ('2v2 scramble', '2v2 scramble'), ('1v1 matchplay', '1v1 matchplay'), ('please select', 'please select')], default='please select', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.golfer')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='members',
            field=models.ManyToManyField(through='golf_trip.Trip_TeamMember', to='accounts.golfer'),
        ),
        migrations.AddField(
            model_name='trip_team',
            name='trip',
        ...
        migrations.AddField(
            ...
            name='team',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='golf_trip.trip_team'),
        ),
        migrations.AddField(
            model_name='trip_golfer',
            name='trip',
