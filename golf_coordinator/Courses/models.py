...
class Golf_Tee(models.Model):
    ...
    hole_10_par = models.IntegerField(choices=PAR, default = PAR[1][1])
    hole_10_yardage = models.IntegerField(default = 0)
    hole_10_index = models.IntegerField(choices=INDEX, default = INDEX[0][0])

    hole_11_par = models.IntegerField(choices=PAR, default = PAR[1][1])
    hole_11_yardage = models.IntegerField(default = 0)
    hole_11_index = models.IntegerField(choices=INDEX, default = INDEX[0][0])

    hole_12_par = models.IntegerField(choices=PAR, default = PAR[1][1])
    hole_12_yardage = models.IntegerField(default = 0)
    hole_12_index = models.IntegerField(choices=INDEX, default = INDEX[0][0])

    hole_13_par = models.IntegerField(choices=PAR, default = PAR[1][1])
    hole_13_yardage = models.IntegerField(default = 0)
    hole_13_index = models.IntegerField(choices=INDEX, default = INDEX[0][0])

    hole_14_par = models.IntegerField(choices=PAR, default = PAR[1][1])
    hole_14_yardage = models.IntegerField(default = 0)
    hole_14_index = models.IntegerField(choices=INDEX, default = INDEX[0][0])

    hole_15_par = models.IntegerField(choices=PAR, default = PAR[1][1])
    hole_15_yardage = models.IntegerField(default = 0)
    hole_15_index = models.IntegerField(choices=INDEX, default = INDEX[0][0])

    hole_16_par = models.IntegerField(choices=PAR, default = PAR[1][1])
    hole_16_yardage = models.IntegerField(default = 0)
    hole_16_index = models.IntegerField(choices=INDEX, default = INDEX[0][0])

    hole_17_par = models.IntegerField(choices=PAR, default = PAR[1][1])
    hole_17_yardage = models.IntegerField(default = 0)
    hole_17_index = models.IntegerField(choices=INDEX, default = INDEX[0][0])

    hole_18_par = models.IntegerField(choices=PAR, default = PAR[1][1])
